        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <ul className="space-y-3 text-gray-700">
              <li>
                <strong>Address:</strong> 123 Jobify Lane, New Delhi, India
              </li>
              <li>
                <strong>Email:</strong> kumardipanshu983542@hmail.com
              </li>
              <li>
                <strong>Phone:</strong> +91 7667233823
              </li>
              <li>
                <strong>Working Hours:</strong> Mon - Fri, 9:00AM - 6:00PM
              </li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <form
              className="grid grid-cols-1 gap-5 text-gray-800"
